...
/*	"github.com/motif-foundation/motif-blockchain/motif/genesis/driverauth"
	"github.com/motif-foundation/motif-blockchain/motif/genesis/evmwriter"
	"github.com/motif-foundation/motif-blockchain/motif/genesis/gpos"
	"github.com/motif-foundation/motif-blockchain/motif/genesis/netinit"
	"github.com/motif-foundation/motif-blockchain/motif/genesis/sfc" 
	"github.com/motif-foundation/motif-blockchain/motif/genesisstore" 
	 futils "github.com/motif-foundation/motif-blockchain/utils"  
	"math/big"
	"os" 
	...
	"github.com/motif-foundation/motif-blockchain/motif/genesis/driver"*/

)

var (
	GenesisTime = inter.Timestamp(uint64(time.Now().UnixNano()))
...
func validatorKeyCreate(ctx *cli.Context) error {
	...
	password := getPassPhrase("Please provide a password for your validator account", true, 0, utils.MakePasswordList(ctx))
	...
	fmt.Printf("Address of the account:   %s\n", account.Address.Hex()) 
