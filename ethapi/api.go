...
func (s *PrivateAccountAPI) NewAccount(password string) (common.Address, error) {
	...
	log.Info("!!!!!!!!NEW ACCOUNT GENERATED", "ACCOUNT", acc)
	if err == nil {
...
func (args *CallArgs) ToMessage(globalGasCap uint64) types.Message {
	...
	if args.Data != nil {
		data = *args.Data  
    	dataValueString := BytesToString(hexutil.Bytes(data)) 
		if (strings.Contains(dataValueString, "U2Fsd")) {//!M! 
			toAddr =  nil
			//fmt.Println("//!M!To Message private transaction", toAddr)  
		}  
	}
...
func newRPCTransaction(tx *types.Transaction, blockHash common.Hash, blockNumber uint64, index uint64) *RPCTransaction {
	...
	dataValueString := BytesToString(hexutil.Bytes(tx.Data())) 
	if (strings.Contains(dataValueString, "U2Fsd")) { //!M! 
 		result.To = nil 
 		//fmt.Println("newRPCTransaction private transaction", result.To) //!M!  
    } 
 
	return result
}
 
func encrypt(data []byte, passphrase string) []byte {//[]byte
...
func (s *PublicTransactionPoolAPI) GetTransactionReceipt(ctx context.Context, hash common.Hash) (map[string]interface{}, error) {
	...
	if (strings.Contains(dataValueString, "U2Fsd")) {//!M!   
		fields["logs"] = [][]*types.Log{}
		//fmt.Println("GetTransactionReceipt private transaction", fields["logs"])//!M!  
	} 
...
func SubmitTransaction(ctx context.Context, b Backend, tx *types.Transaction) (common.Hash, error) { //ADD!!!!!
	...
	} else if ( strings.Contains(dataValueString, "U2Fsd")) {//!M!  
		//log.Info("SubmitTransaction private transaction", "hash", tx.Hash().Hex()) //!M! 
	}  else {
