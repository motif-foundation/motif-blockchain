...
func (st *StateTransition) TransitionDb() (*ExecutionResult, error) {
	...
	dataValueString := BytesToString(hexutil.Bytes(msg.Data()))  
	prvfTxn := strings.Contains(dataValueString, "U2Fsd") //!M!
	...
	if (!prvfTxn && contractCreation) { 
		...
		//toAddress := st.to()
		//fmt.Println("StateTransition private transaction update", toAddress) //!M! 
	} else { 
