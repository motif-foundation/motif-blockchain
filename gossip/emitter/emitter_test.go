...
import (
	...
	"github.com/motif-foundation/motif-blockchain/gossip/emitter/mock"
...
//go:generate go run github.com/golang/mock/mockgen -package=mock -destination=mock/world.go github.com/motif-foundation/motif-blockchain/gossip/emitter External,TxPool,TxSigner,Signer
